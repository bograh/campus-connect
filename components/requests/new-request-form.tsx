...
import { MapPin, DollarSign, Clock, ArrowLeft, AlertCircle } from "lucide-react"
...
export function NewRequestForm() {
  ...
  const urgencyLevels = [
    ...
    { value: "medium", label: "Medium Priority", description: "Needed within 24 hours" },
    { value: "high", label: "High Priority", description: "Urgent - needed ASAP" },
  ]
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Basic validation
    if (!formData.title || !formData.description || !formData.fromLocation || !formData.toLocation) {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Post a delivery request for verified students to accept</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Provide details about what you need delivered</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Set urgency level and deadline for your request</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
                ...
                {urgencyLevels.map((level) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {formData.urgency === level.value && <Badge variant="secondary">Selected</Badge>}
                    </div>
                  </div>
                ))}
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Any special instructions or requirements</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
