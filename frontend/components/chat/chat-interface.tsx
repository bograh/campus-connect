...
const mockMessages: Message[] = [
  {
    id: "1",
    senderId: "system",
    content: "You've been matched for a delivery request: 'Textbook from Library to Hostel A'",
    timestamp: "10:30 AM",
    type: "system",
  },
  {
    id: "2",
    senderId: "2",
    content: "Hi! I saw your delivery request. I can help you with that!",
    timestamp: "10:32 AM",
    type: "text",
  },
  {
    id: "3",
    senderId: "1",
    content: "That's great! When would be a good time for you?",
    timestamp: "10:35 AM",
    type: "text",
  },
  {
    id: "4",
    senderId: "2",
    content: "I'm heading to the library around 2 PM today. Would that work?",
    timestamp: "10:37 AM",
    type: "text",
  },
  {
...
const mockDeliveryInfo = {
  ...
  title: "Textbook from Library to Hostel A",
  pickup: "Main Library - Ground Floor",
  dropoff: "Hostel A - Room 204",
  fee: "GH₵ 5.00",
  status: "active",
}
            ...
            <div className="flex items-center gap-3 flex-1">
              <div className="relative">
                <Avatar className="h-10 w-10">
                  <AvatarImage src={mockParticipant.avatar || "/placeholder.svg"} />
                  <AvatarFallback>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge variant={mockDeliveryInfo.status === "active" ? "default" : "secondary"}>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-medium text-green-600">{mockDeliveryInfo.fee}</span>
                </div>
              </div>
            </div>
          </div>
                    ...
                    >
                      ...
                      <p
                        className={`text-xs mt-1 ${
                          message.senderId === "1" ? "text-primary-foreground/70" : "text-muted-foreground"
                        }`}
                      >
                        {message.timestamp}
                      </p>
